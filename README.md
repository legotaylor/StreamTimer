# StreamTimer  
Download the latest version [here](https://github.com/legotaylor/StreamTimer/releases).

**Requires Java 11 or later**

## Features
- Customizable Font, Text Colour, Background Colour, and GLSL Shaders.
- Twitch Integration
- WebSocket to Canvas (Browser Source)
